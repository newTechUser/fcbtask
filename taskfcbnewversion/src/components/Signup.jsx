                            ...
                            ({values}) => (
                                <Form className='boxform'>
                                    <div className="form">
                                        ...
                                        <Field className="num" type="email" name="Mobilenumberoremail" placeholder="Mobile number or email"></Field><br/><br/>
                                        <Field className="num" name="Newpassword" type="password" placeholder="New password"></Field><br/>
                                            ...
                                            <div className="birthselect">
                                                <div className="shape">
                                                    <div className="shapecontent">
                                                        <span>Female</span>
                                                        <Field type="radio" name="Female" />
                                                    </div>
                                                </div>
                                                <div className="shape">
                                                    <div className="shapecontent">
                                                        <span>Male</span>
                                                        <Field type="radio" name="Male"/>
                                                    </div>
                                                </div>
                                                <div className="shape">
                                                    <div className="shapecontent">
                                                        <span>Custom</span>
                                                        <Field type="radio"name="Custom" />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="boxdivbtn">
                                            <button className="boxbtn">Sign Up</button>
                                        </div>
                                    </div>
                                </Form>
                            )
